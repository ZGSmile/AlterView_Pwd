...
- (void)showKeyboard
{
    ...
    [UIView animateWithDuration:0.3 delay:0 options:UIViewAnimationOptionCurveEaseInOut animations:^{
        self.keyboard.transform = CGAffineTransformMakeTranslation(0, -self.keyboard.ZG_height);
        self.inputView.transform = CGAffineTransformMakeTranslation(0, marginTop - self.inputView.ZG_y);
...
- (void)showInView:(UIView *)view
{
    ...
    /** 键盘起始frame */
    self.keyboard.ZG_x = 0;
    self.keyboard.ZG_y = ZCScreenHeight;
    self.keyboard.ZG_width = ZCScreenWidth;
    self.keyboard.ZG_height = ZCScreenWidth * 0.65;
    
    /** 输入框起始frame */
    self.inputView.ZG_height = ZCScreenWidth * 0.5625;
    self.inputView.ZG_y = (self.ZG_height - self.inputView.ZG_height) * 0.5;
    self.inputView.ZG_width = ZCScreenWidth * 0.94375;
    self.inputView.ZG_x = (ZCScreenWidth - self.inputView.ZG_width) * 0.5;
